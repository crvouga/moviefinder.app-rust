...
use super::{account_screen, edit_profile, login, login_with_sms, logout};

#[derive(Serialize, Deserialize, Debug, PartialEq, Clone)]
pub enum Route {
    AccountScreen(account_screen::route::Route),
...
impl AppRoute for account_screen::route::Route {
    fn url(&self) -> String {
        Route::AccountScreen(self.clone()).url()
    }
}
