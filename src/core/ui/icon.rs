...
pub fn spinner(class: &str) -> Elem {
    add_class(SPINNER, class)
}

const HOME: &str = r#"
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" ATTRS>
...
pub fn adjustments_vertical(class: &str) -> Elem {
    add_class(ADJUSTMENTS_VERTICAL, class)
}
...
pub fn magnifying_glass(class: &str) -> Elem {
    add_class(MAGNIFYING_GLASS, class)
}
...
pub fn pencil(class: &str) -> Elem {
    add_class(PENCIL, class)
}

const DOOR_OPEN: &str = r#"
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill="currentColor" ATTRS>
