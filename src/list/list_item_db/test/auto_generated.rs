...
mod tests {
    ...
    use crate::{
        ...
        list::{
            ...
            list_item_db::{impl_auto_generated::ImplAutoGenerated, interface::ListItemDb},
        },
        media::interaction::{
    ...
    async fn fixtures() -> Vec<Fixture> {
        ...
        let media_interaction_db = base.ctx.media_interaction_db;

        let list_db = Arc::new(list_db::impl_auto_generated::ImplAutoGenerated::new(
            media_interaction_db.clone(),
        ));
        fixtures.push(Fixture {
            interaction_db: media_interaction_db.clone(),
            list_db: list_db.clone(),
            list_item_db: Arc::new(ImplAutoGenerated::new(
                media_interaction_db.clone(),
                list_db.clone(),
            )),
        });
