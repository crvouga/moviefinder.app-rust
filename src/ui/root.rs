    ...
    pub fn view(self) -> Html {
        ...
        .child(
            head().children(vec![
                ...
                // Tailwind is compiled at build time (see Dockerfile / `just
                // tw-build`) into public/output.css. Theme extensions live in
                // tailwind.config.js. Do NOT switch back to cdn.tailwindcss.com
                // — it logs a production warning and pulls a 3MB JIT runtime.
